...
const miniAppFeatures: MiniAppFeature[] = [
    {
        title: 'Plug & Play',
        description: 'Access utility apps instantly, no browser switching or wallet popups.',
        icon: puzzle,
        bgColor: 'bg-blue-200',
        bgImage: animals
    },
    {
        ...
        description: 'Use stablecoins to pay for electricity, internet, airtime and more.',
        icon: pay,
    ...
    },
    {
        ...
        description: 'Complete simple in-app tasks and earn stablecoin bonuses every day.',
        icon: prize,
        bgColor: 'bg-pink-300',
        bgImage: shapes
    },
        ...
        <section className="px-1 py-6 bg-pink-100" ref={ref}>
            <div className="max-w-4xl mx-auto text-center mb-3">
                ...
                <p className={`${inView ? 'slide-in' : ''} text-gray-600 mb-1`}>
                    From paying bills to earning yield—interact with real-world financial services, right from your wallet.
                </p>
